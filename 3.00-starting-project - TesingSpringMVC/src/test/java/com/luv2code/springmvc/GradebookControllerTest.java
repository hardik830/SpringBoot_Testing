...
public class GradebookControllerTest {
    ...
    public void deleteStudentHttpRequest() throws Exception {
        //student with id 1 it should be present in the database
        //because on performing this test before method is executed
        //in which we crated already a student with id 1
